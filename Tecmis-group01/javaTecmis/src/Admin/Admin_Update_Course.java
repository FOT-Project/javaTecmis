 ...
 * @author Hasitha
 */
public class Admin_Update_Course extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Update_Course
     */
    public Admin_Update_Course() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Remove Course");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/update-time_table.jpg"))); // NOI18N
        ...
        txtSubId.setFont(new java.awt.Font("Iskoola Pota", 1, 20)); // NOI18N
        ...
        txtDepartment.setFont(new java.awt.Font("Iskoola Pota", 1, 20)); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtSubId, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        Admin_Course_Dashboard dashboard = new Admin_Course_Dashboard();
        dashboard.show();
        dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        String courseId = txtSubId.getText();
        ...
        try {
            ...
            String sql = "DELETE FROM course WHERE c_id = '" + courseId + "' AND dep_id = '" + department + "'";
            ...
            Done_Alert done = new Done_Alert();
                ...
                public void windowClosed(WindowEvent e) {
                    Admin_Update_Course update = new Admin_Update_Course();
                    update.show();
                }
            });
            done.show();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Update_Course.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Update_Course().setVisible(true);
            }
        });
    }
