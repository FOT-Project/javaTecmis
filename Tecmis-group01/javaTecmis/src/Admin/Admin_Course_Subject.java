 ...
 * @author Hasitha
 */
public class Admin_Course_Subject extends javax.swing.JFrame {

    /**
     * Creates new form Admin_Course_Subject
     */
    public Admin_Course_Subject() {
        initComponents();
    ...
    private void jLabel1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel1MouseClicked
        ...
        Admin_Find_Course course = new Admin_Find_Course();
        course.show();
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Admin_Course_Subject.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Admin_Course_Subject().setVisible(true);
            }
        });
    }
