 ...
 * @author USER
 */
public class lecturer_update_profile extends javax.swing.JFrame {

    /**
     * Creates new form lecturer_add_profile2
     */
    public lecturer_update_profile() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lecturer_update_profile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new lecturer_update_profile().setVisible(true);
            }
        });
    }
